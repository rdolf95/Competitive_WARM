...
typedef enum {
  ...
  /* FTL Stat file configuration*/
  FTL_GC_STAT_FILE,
  FTL_REFRESH_STAT_FILE,
...
class Config : public BaseConfig {
 private:
  ...
  std::string gcStatFile;       //!< Default : ./log/gcStat.txt
  std::string refreshStatFile;  //!< Default : ./log/refreshStat.txt

  float hotBlocksRatio;         //!< Default : 0.1

  uint32_t coolDownWindowSize;   //!< Default : 20
