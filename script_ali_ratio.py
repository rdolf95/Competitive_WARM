...
## Usage : python3 script_ali_days.py {trace1} {trace2} ... {hot_ratio} {peCycle}

len_argv = len(argv)
peCycle = argv[len_argv - 1]
hot_ratio = argv[len_argv - 2]
for i in range (1, len_argv - 2):
    ...
    print("########################################################################################")
    stdout.flush()
    ssd_config = "alibaba" + "_pe" + peCycle + "_" + hot_ratio + ".cfg"
    others = "hot" + hot_ratio
